...
const Details = () => {
    ...
    useEffect(() => {
        if (updatingProduct) {
            ...
            setProductDescription(updatingProduct.description);
        ...
        Alert.alert("Update Product", "Are you sure you want to update this product?", [
            {
                ...
                style: 'cancel',
                onPress: () => {
                    updateProduct({ id: updatingProduct.id, name: productName, image: selectedImage, category: productCategory, price: parseFloat(productPrice),productDescription: productDescription }, {
                        onSuccess: () => {
                            navigation.goBack();
                        }
                    });
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.imageContainer}>
                <Image source={ selectedImage ? { uri: selectedImage } : defaultImage } style={styles.image} />
            ...
            <View style={styles.inputContainer}>
                ...
                <TextInput value={productDescription} onChangeText={(v) => setProductDescription(v)} placeholder="Long Description" style={styles.input} />
            ...
            <View style={styles.buttonContainer}>
                ...
                <Pressable onPress={handleDelete} style={[styles.button, { backgroundColor: colors.orange }]}>
